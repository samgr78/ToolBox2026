<div class="kt-drawer kt-drawer-end w-[450px] m-5 rounded-xl border-input" id="teacher-drawer" data-kt-drawer="true">
    <div class="kt-drawer-header">
        <h3 class="kt-drawer-title">Ajouter un enseignant</h3>
    </div>
